...
# ╔═╡ d2ae57da-6da2-408f-90fc-49acf7de6a17
begin
	using Distributions
	using Random, Plots
	using LinearAlgebra
...
# ╔═╡ ce20621c-a594-4fd7-907d-38e3f25eccaa
md"# Welcom to this class"

# ╔═╡ 0446d4eb-4378-439a-8a1a-b7d5c4cdb063
md"
- Date. July 18
- Author. JW
"

# ╔═╡ 50602de7-03e2-4ed8-b318-94d18794040b
md"## Let's build a IRT leaning machine"

# ╔═╡ 42bfa620-fe63-4940-ba3b-7f3a3b0acbd7
theme(:juno)

# ╔═╡ c6a8037f-ea66-4b14-a435-a1a98f27c03c
sigmoid(t) = 1 / (1+exp(-t))

# ╔═╡ 3638153d-d691-4436-a92b-c1a44f7f3920
function irt3Pl(a,b,c)
	θ = rand(Normal(),1000)
	p = c .+ (1-c).*sigmoid.(a.*(θ .- b))
	return θ, p
end

# ╔═╡ c80ea8e3-d234-4163-8419-6ffb4f9795c3
md"透過調整 a,b,c 三個參數的搖桿，即可畫出相對應的試題特徵曲線 ICC！"

# ╔═╡ 03525216-cbbe-4b34-b210-090e0726fe68
@bind a Slider(0:0.1:3)

# ╔═╡ 2fe8e72d-190d-4b37-8751-a739c06eb3f0
@bind b Slider(-3:0.1:3)

# ╔═╡ 77a97e1b-4adb-434c-a06e-bb05a28a0941
@bind c Slider(0:0.1:1)

# ╔═╡ 9fdb0ffe-08ba-4fdc-864d-d181934af99b
a,b,c

# ╔═╡ f26a112e-6a92-4eaa-8ac8-9c91c3c6bfca
begin
	
	plot(irt3Pl(a,b,c), ylims=(0,1), seriestype=:line )
	scatter!(irt3Pl(a,b,c), ylims=(0,1))
end

# ╔═╡ e1b27e15-3c93-4723-a80d-d77ab3ee687c
histogram(irt3Pl(a,b,c)[1])
...
PolyaGammaDistribution = "5d96170c-d9fd-4420-bed5-7554cecc1fd7"
...
manifest_format = "2.0"
project_hash = "253fe968636326a5a1a1261dd584d99cf4fccaca"
...
[[deps.PolyaGammaDistribution]]
deps = ["Distributions", "Random", "SpecialFunctions", "StatsFuns"]
git-tree-sha1 = "119c8ba499ce755b7cf3c5215b6189499f6b9325"
uuid = "5d96170c-d9fd-4420-bed5-7554cecc1fd7"
version = "0.1.0"
